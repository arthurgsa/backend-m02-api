const lixoDigitado = 'Não quero importar isto.'
const profs = [
  { id: 1, nome: 'Arthur', stack: 'Backend' },
  { id: 2, nome: 'Bruno', stack: 'Frontend' },
  { id: 3, nome: 'Carlos', stack: 'Frontend' },
  { id: 4, nome: 'Dani', stack: 'Backend' }
]
